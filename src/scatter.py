...
def user_input():
    ...
    return minX_rotation, maxX_rotation, minY_rotation, maxY_rotation, minZ_rotation, maxZ_rotation, min_scale, max_scale
...
def ran_scaling(new_instance, min_scale, max_scale):
...
def place_instances():
    ...
    for vert in selected_verts:
        ...
        ran_rotation(new_instance, minX_rotation, maxX_rotation,
                     minY_rotation, maxY_rotation,
                     minZ_rotation, maxZ_rotation)
        #ran_scaling(new_instance, min_scale,max_scale)
